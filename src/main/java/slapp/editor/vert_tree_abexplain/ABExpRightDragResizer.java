...
/**
 * {@link ABExpRightDragResizer} can be used to add mouse listeners to a {@link Region}
 ...
 *
 */
public class ABExpRightDragResizer {
    ...
    public ABExpRightDragResizer(VerticalTreeABExpView verticalTreeView) {
