...
public class ABExpMapQuestionMarker extends Pane {
    ...
    public ABExpMapQuestionMarker(VerticalTreeABExpView verticalTreeView) {
    ...
    public void bindQuestionLabel (ABExpMapFormulaBox formulaBox) {
