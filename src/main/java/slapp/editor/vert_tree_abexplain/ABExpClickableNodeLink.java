...
public class ABExpClickableNodeLink extends Pane {
    ...
    public ABExpClickableNodeLink(VerticalTreeABExpView verticalTreeView) {
    ...
    public void bindEnds (ABExpTreeFormulaBox source, ABExpTreeFormulaBox target) {
