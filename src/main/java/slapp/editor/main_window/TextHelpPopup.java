...
static {
    ...
    about = "<body style=\"margin-left:10; margin-right: 20\">"+
            ...
            "<p style = \"text-align: center;\">Version 1.02&#x03b1 (build 1)</p>" +
    ...
    commonElements = "<body style=\"margin-left:10; margin-right: 20\">" +
            ...
            "<ul><li>The assignment dropdown has the usual operations: save, save as, open, close, print, and export to PDF.  (The export option is disabled on Mac: to create a PDF on Mac, select the regular SLAPP print option and then the PDF dropdown from the Mac printer window.)  The 'create' options are of special interest to instructors.<br><br></li>" +
            ...
            "<li>There can be a related problem with system <i>dead keys</i>.  As for ones in SLAPP, these place an accent on the next (or previous) typed character, and are a function of your system's keyboard map.  You want system dead keys off. Dead keys are not usually a problem on PC.  And Mac makes it easy to switch from one mapping to another:<br><br></li>" +
    ...
    verticalTrees = "<body style=\"margin-left:10; margin-right: 20\">" +
            ...
            "<li>Both the screen and print height of a vertical tree are controlled by the height spinner.  Adjust to fit.  To avoid excessive blank space on a printed page, it is a good idea to 'snug up the space whenever you are done with a problem.<br><br></li>" +
