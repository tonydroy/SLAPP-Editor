...
public class ExpClickableNodeLink extends Pane {
    ...
    public ExpClickableNodeLink(VerticalTreeExpView verticalTreeView) {
    ...
    public void bindEnds (ExpTreeFormulaBox source, ExpTreeFormulaBox target) {
