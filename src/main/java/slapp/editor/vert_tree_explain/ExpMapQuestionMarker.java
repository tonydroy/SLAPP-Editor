...
public class ExpMapQuestionMarker extends Pane {
    ...
    public ExpMapQuestionMarker(VerticalTreeExpView verticalTreeView) {
    ...
    public void bindQuestionLabel (ExpMapFormulaBox formulaBox) {
