...
/**
 * {@link ExpRightDragResizer} can be used to add mouse listeners to a {@link Region}
 ...
 *
 */
public class ExpRightDragResizer {
    ...
    public ExpRightDragResizer(VerticalTreeExpView verticalTreeView) {
