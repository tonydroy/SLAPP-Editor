...
public class ExpVerticalBracket extends AnchorPane {
    ...
    private final ExpVerticalBracket self;

    private VBox mainPane;



    public ExpVerticalBracket(VerticalTreeExpView verticalTreeView) {
        self = this;
...
//        brackPane.setMinHeight(24); brackPane.setMaxHeight(24);
        ...
        ExpBottomDragResizer resizer = new ExpBottomDragResizer(verticalTreeView);
