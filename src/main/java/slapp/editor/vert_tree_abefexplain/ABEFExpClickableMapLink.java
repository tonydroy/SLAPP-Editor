...
import slapp.editor.vert_tree_abefexplain.ABEFExpMapFormulaBox;
...
public class ABEFExpClickableMapLink extends Pane {
    ...
    public ABEFExpClickableMapLink(VerticalTreeABEFExpView verticalTreeView) {
    ...
    public void bindEnds (ABEFExpMapFormulaBox box1, ABEFExpMapFormulaBox box2) {
        ABEFExpMapFormulaBox source;
        ABEFExpMapFormulaBox target;
