...
public class ABEFExpMapQuestionMarker extends Pane {
    ...
    public ABEFExpMapQuestionMarker(VerticalTreeABEFExpView verticalTreeView) {
    ...
    public void bindQuestionLabel (ABEFExpMapFormulaBox formulaBox) {
