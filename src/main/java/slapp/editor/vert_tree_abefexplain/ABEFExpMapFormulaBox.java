...
public class ABEFExpMapFormulaBox extends AnchorPane {
    ...
    private final ABEFExpMapFormulaBox self;
    ...
    public ABEFExpMapFormulaBox(VerticalTreeABEFExpView verticalTreeView) {
