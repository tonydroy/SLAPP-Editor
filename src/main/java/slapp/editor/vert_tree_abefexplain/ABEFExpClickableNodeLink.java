...
import slapp.editor.vert_tree_abefexplain.ABEFExpTreeFormulaBox;
...
public class ABEFExpClickableNodeLink extends Pane {
    ...
    public ABEFExpClickableNodeLink(VerticalTreeABEFExpView verticalTreeView) {
    ...
    public void bindEnds (ABEFExpTreeFormulaBox source, ABEFExpTreeFormulaBox target) {
