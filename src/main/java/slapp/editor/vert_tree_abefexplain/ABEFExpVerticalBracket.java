...
public class ABEFExpVerticalBracket extends AnchorPane {
    private VerticalTreeABEFExpView verticalTreeView;
    ...
    private final ABEFExpVerticalBracket self;

    private VBox mainPane;



    public ABEFExpVerticalBracket(VerticalTreeABEFExpView verticalTreeView) {
        self = this;
...
//        brackPane.setMinHeight(24); brackPane.setMaxHeight(24);
        ...
        ABEFExpBottomDragResizer resizer = new ABEFExpBottomDragResizer(verticalTreeView);
