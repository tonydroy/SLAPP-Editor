...
public class ABEFExpDashedLine extends AnchorPane {
    ...
    private final ABEFExpDashedLine self;

    private AnchorPane mainPane;



    public ABEFExpDashedLine(VerticalTreeABEFExpView verticalTreeView) {
        self = this;
