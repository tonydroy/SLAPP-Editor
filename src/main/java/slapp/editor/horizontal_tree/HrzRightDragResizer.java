...
/**
 * {@link HrzRightDragResizer} can be used to add mouse listeners to a {@link Region}
 ...
 *
 */
public class HrzRightDragResizer {
    ...
    public HrzRightDragResizer(HorizontalTreeView horizontalTreeView) {
