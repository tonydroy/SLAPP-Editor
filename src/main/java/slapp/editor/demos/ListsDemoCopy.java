...
public class ListsDemoCopy {
    ...
    public void listsDemo(Stage stage) {
        ...
        scene.getStylesheets().add(HighlightDemoCopy.class.getClassLoader().getResource("listsDemo.css").toExternalForm());
